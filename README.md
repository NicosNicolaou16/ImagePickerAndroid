...
application with latest Android technologies. Its supports Activity and Fragment with XML and Jetpack Compose.<br />
...
```Groovy
implementation 'com.github.NicosNicolaou16:ImagePickerAndroid:2.0.13'
```
