...
val composeVersion by extra("1.6.6")
val composeLiveDataVersion by extra("1.6.6")
val composeFoundationVersion by extra("1.6.6")
val composeMaterialVersion by extra("1.6.6")
